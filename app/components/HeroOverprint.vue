...
.hero {
   ...
   * Mobile forms are larger once separated, while the overprint remains the
   * original 11rem. Five forms still fit a 320px viewport by stepping 53px.
   */
  --form-size: 3.75rem;
  --form-step: 3.3125rem;
  --stack-scale: 2.933333;
