export const zhCN = {
  meta: {
    ...
    name: 'Hanji',
    description:
      '中国大陆、香港、台湾、日本、韩国五地常用汉字的字形对照。同一个字，各地写出来常常不一样。',
  },
  region: {
  ...
  filter: {
    ...
    glyph: '字形',
    cp: '码点',
    glyphHint: '按写出来的样子比较。五地用同一个码点但笔画不同，也算不同。',
  ...
  about: {
    ...
    license: '许可',
    method1:
      'Source Han Sans与Source Han Serif（也就是Noto Sans CJK与Noto Serif CJK）各自的五个地区共享同一个字形池，每个地区有一份「码点→CID」映射。同一个池子里CID相同就是同一个字形，所以把中国大陆、香港、台湾、日本、韩国五份映射摆在一起比对，就能判断这五地把一个字写成了几种样子。',
    method2:
    ...
    scope2:
      '其中{identical}行五地写法完全一致，{allDiffer}行五地各不相同。写法相同的字同样收录——这里是五地汉字的字表，字形差异只是其中一个维度。',
    scope3:
