export const zhCN = {
  ...
  about: {
    ...
    method2:
      '最终判定取黑体与宋体结果的并集：只要其中一款把两地画成同一字形，本站就按同形处理。这能排除只出现在单款字体中的设计细节。例如Source Han Sans为约五分之一的日本常用汉字提供独立字形，其中约两百个在Source Han Serif并未区分，像了、人、子、水、金；本站不把这类差异算作地区规范差异。',
    method3:
